...
<html>
	<head>
		...
		<script src="${pageContext.request.contextPath}/js/dashboards/tasksPerSprint.js"></script>
	...
	<body>
		<div class="main-content p-2" style="margin-left:0px !important;">
			...
			%>
				<div class="col-6 text-end mb-1">
					<a class="sprint-scrum-team"
						href="${pageContext.request.contextPath}/sprints/add-scrum-to-sprint-form1/id/${sprint.id}/project/${sprint.project}">
									
						<i class="fa fa-users" aria-hidden="true"></i></a>

					<button id="ghx-complete-sprint" class="aui-button js-complete-sprint"
						onclick="completeSprint('${pageContext.request.contextPath}',${sprint.id },${sprint.project})">Complete
						Sprint</button>
					<button id="ghx-sprint-status" class="aui-button js-sprint-status "
						onclick="sprintStatus('${pageContext.request.contextPath}',${sprint.id },${sprint.project})">Sprint
						Status</button>
			...
			%>
				<div class="col-6 text-end">
					...
					<button id="ghx-sprint-status" class="aui-button js-sprint-status"
						onclick="sprintStatus('${pageContext.request.contextPath}',${sprint.id },${sprint.project})">Sprint Status</button>
				</div>
				<%
			}
			%>
			...
			<div class="container d-flex justify-content-center">
				<div class="col-12 col-offset-2 task-content border row">
					...
					<div class="d-none">
						<form action="${pageContext.request.contextPath}/tasks/update/task/${sprint.project}/${sprint.id}" method="POST"
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
							onclick="window.location.href='${pageContext.request.contextPath}/dashboard/stories/${sprint.project}/${sprint.id }'">
						</button>
					</div>
					...
					<div class="modal-body">
						<form action="${pageContext.request.contextPath}/sprints/close-sprint" method="post" class=""
							...
							<div class="mx-auto text-center mt-3">
									<button type="button" class="btn btn-secondary btn-sm" id="user-cancel"
										onclick="window.location.href='${pageContext.request.contextPath}/dashboard/stories/${sprint.project}/${sprint.id }'">Cancel</button>
						...
						<form action="${pageContext.request.contextPath}/sprints/close-sprint" method="get" class=""
							...
							<div class="row">
								...
								<div class="col-md-12 p-0">
									<div class=" mx-2 my-1 bg-light rounded p-2  border" style="height: 250px;">
							...
							<div class="card col-md-12 border my-1 p-0">
								...
								<div class="card-body card-height d-flex justify-content-between">
									<button type="button" class="btn btn-outline-secondary btn-sm my-2"
										id="all-tasks-sprint-status"
										onclick="getTask('${pageContext.request.contextPath}')"
										style="padding: 1px 10px">All Task</button>
									<div style="width: 108px;">
										<select class="form-select"
											onchange="taskFilter('${pageContext.request.contextPath}',this,${sprint.id })">
							...
							<div class="mb-12 row">
								<div class="mt-3">
									<button type="button" class="btn btn-secondary btn-sm" style="float: right;"
										id="user-cancel"
										onclick="window.location.href='${pageContext.request.contextPath}/dashboard/stories/${sprint.project}/${sprint.id }'">Close</button>
								</div>
							</div>
						</form>
