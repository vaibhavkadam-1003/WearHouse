...
<script src="${pageContext.request.contextPath}/js/sprintHistoryDashboard.js"></script>
</head>
<body>
		...
		<div class="row">
			<div class="col-md-12 bg-light p-2" style="height: 258px">
				<div class=" mx-2 my-1 bg-light rounded p-2" style="height: 200px;">
					<div id="sprint-history-user-tasks-chart" class="border"></div>
				</div>
			</div>
		</div>
					...
					<div class="card-body card-height">
						<div class="d-flex justify-content-between align-items-center">
							<button type="button"
								...
								onclick="getTask(${sprintId})" id="all-tasks-history"
