			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<c:if test="${scrumTeamMessage == null}">
						<form
							action="${pageContext.request.contextPath}/sprints/add-scrum-to-sprint"
							...
							<div class="mb-3 row">
								<div class="mx-auto text-center mt-3">
									<button type="button" class="btn btn-secondary btn-sm"
										id="user-cancel"
										onclick="window.location.href='${pageContext.request.contextPath}/sprints/stories2'">Cancel</button>
